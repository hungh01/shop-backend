...
const addProductCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedProduct = yield categoriesService.addProductCategory(req.body);
...
const getProductCategories = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categories = yield categoriesService.getProductCategories();
        res.json(categories);
    }
    catch (error) {
        next(error);
...
const getCategoriesById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categoryId = req.params.categoryId;
        const page = req.query.page ? +req.query.page : 1;
        const limitPage = req.query.limitPage ? +req.query.limitPage : 8;
        const categories = yield categoriesService.getCategoriesById(+categoryId, page, limitPage);
        if (!categories) {
